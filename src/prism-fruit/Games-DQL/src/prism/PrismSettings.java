...
public class PrismSettings implements Observer
{
	...
	// APT vs DIFT
	public static final String OUTPUT_DIR							= "heuristic.outputDir";
	...
	public static final Object[][][] propertyData =
	{
		{	//Datatype:			Key:									Display name:							Version:		Default:																	Constraints:																				Comment:
			...
			// APT vs DIFT
			{ STRING_TYPE,      OUTPUT_DIR,							"Output Directory",						"4.1",   	 	new String("temp"),     														"",
																			"Directory for outputting best and worst case games for APT vs DIFT" },
		},
		{
	...
	public synchronized int setFromCommandLineSwitch(String args[], int i) throws PrismException
	{
		...
		// APT vs DIFT
		else if (sw.equals("outputDir")) {
			set(OUTPUT_DIR, args[++i]);
		}
