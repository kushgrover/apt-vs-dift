...
public class SMG extends STPGExplicit implements STPG
{
	...
	//set of players in the coalition; used only by and for the heuristicRTDP_Adj
	protected Set<Integer> coalition;
	public Set<Integer> getCoalitionSet(){return this.coalition;}
	public void setCoalitionSet(Set<Integer> coalition){this.coalition=coalition;}
	...
	/**
	 * Set coalition of players for this SMG from an intset, which is less obscure then using strings and the coalition object.
	 * @param coalition
	 * @throws PrismException
	 */
	public void setCoalitionPlayerMapFromIntSet(Set<Integer> coalition, int numPlayers)
	{
		coalitionPlayerMap = new int[numPlayers+1];
		for (int i = 0; i < numPlayers+1; i++) {
			coalitionPlayerMap[i] = (coalition.contains(i) ? 1 : 2);
		}
	}
