...
final class CachedFunctionFactory extends FunctionFactory {
	...
	private Object2IntMap<Function> functionToNumber;
	...
	private List<CachedFunction> cachedFunctions;
	...
	private Map<OpCacheKey, CachedFunction> addCache;
	/** cache for multiplications (and indirectly divisions) */
	private Map<OpCacheKey, CachedFunction> multCache;
	/** cache for star operation */
	private Map<CachedFunction, CachedFunction> starCache;
	...
	CachedFunctionFactory(FunctionFactory context) {
		...
		functionToNumber = new Object2IntOpenHashMap<>();
	...
	{
		if (functionToNumber.containsKey(function)) {
			return cachedFunctions.get(functionToNumber.getInt(function));
		}
