...
public final class ParamModelChecker extends PrismComponent
{
	 ...
	 * {@link #setModulesFileAndPropertiesFile(ModulesFile, PropertiesFile)}
	...
	public Result check(Model model, Expression expr) throws PrismException
	{
		...
		NatBitSet needStates = NatBitSets.boundedFilledSet(model.getNumStates());
	 ...
	 * to attach the original model/properties files.
	 */
	RegionValues checkExpression(ParamModel model, Expression expr, NatBitSet needStates) throws PrismException
	{
		RegionValues res;
	...
	private RegionValues checkExpressionAtomic(ParamModel model, Expression expr, NatBitSet needStates) throws PrismException
	{
	...
	protected RegionValues checkExpressionUnaryOp(ParamModel model, ExpressionUnaryOp expr, NatBitSet needStates) throws PrismException
	{
	 ...
	 */
	protected RegionValues checkExpressionBinaryOp(ParamModel model, ExpressionBinaryOp expr, NatBitSet needStates) throws PrismException
	{
	 ...
	 * Model check a label.
	 */
	protected RegionValues checkExpressionLabel(ParamModel model, ExpressionLabel expr, NatBitSet needStates) throws PrismException
	{
		LabelList ll;
		int i;
	...
	protected RegionValues checkExpressionProp(ParamModel model, ExpressionProp expr, NatBitSet needStates) throws PrismException
	{
	...
	protected RegionValues checkExpressionFilter(ParamModel model, ExpressionFilter expr, NatBitSet needStates) throws PrismException
	{
		...
		NatBitSet needStatesInner = NatBitSets.modifiableCopyOf(needStates);
		...
		NatBitSet bsFilter = rvFilter.getStateValues().toBitSet();
		// Check filter satisfied by exactly one state
		FilterOperator op = expr.getOperatorType();
		if (op == FilterOperator.STATE && bsFilter.size() != 1) {
	...
	protected RegionValues checkExpressionFilterParam(ParamModel model, ExpressionFilter expr, NatBitSet needStates) throws PrismException
	{
		// Filter info
		Expression filter = expr.getFilter();
	 ...
	 */
	protected RegionValues checkExpressionProb(ParamModel model, ExpressionProb expr, NatBitSet needStates) throws PrismException
	{
	...
	private RegionValues checkProbPathFormulaSimple(ParamModel model, Expression expr, boolean min, NatBitSet needStates) throws PrismException
	{
		...
		if (expr instanceof ExpressionTemporal) {
			...
			// Until
				...
				NatBitSet needStatesInner = NatBitSets.boundedFilledSet(model.getNumStates());
	...
	private RegionValues checkProbUntil(ParamModel model, RegionValues b1, RegionValues b2, boolean min, NatBitSet needStates) throws PrismException {
	 ...
	 */
	protected RegionValues checkExpressionReward(ParamModel model, ExpressionReward expr, NatBitSet needStates) throws PrismException
	{
	...
	private RegionValues checkRewardFormula(ParamModel model,
			ParamRewardStruct rew, Expression expr, boolean min, NatBitSet needStates) throws PrismException {
	...
	private RegionValues checkRewardReach(ParamModel model, ParamRewardStruct rew, ExpressionTemporal expr, boolean min, NatBitSet needStates)
	...
	private RegionValues checkRewardSteady(ParamModel model,
			ParamRewardStruct rew, ExpressionTemporal expr, boolean min, NatBitSet needStates) throws PrismException {
	 ...
	 */
	protected RegionValues checkExpressionSteadyState(ParamModel model, ExpressionSS expr, NatBitSet needStates) throws PrismException
	{
		Expression pb; // Probability bound (expression)
		BigRational p = null; // Probability bound (actual value)
		//String relOp; // Relational operator
	...
	private RegionValues checkProbSteadyState(ParamModel model, Expression expr, boolean min, NatBitSet needStates)
	throws PrismException
	{
		NatBitSet needStatesInner = NatBitSets.boundedFilledSet(model.getNumStates());
