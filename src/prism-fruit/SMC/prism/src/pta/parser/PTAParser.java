...
public class PTAParser implements PTAParserConstants {
        ...
        static class astEdge
        {
                ...
                public double prob;
                public String dest;
                public Int2IntMap resets;
                // Methods
                public astEdge(double prob, String dest) { this.prob = prob; this.dest = dest; resets = new Int2IntOpenHashMap(); }
                ...
                public void createDataStructures(astPTA pta, Transition trans)
                {
                        ...
                        for (Int2IntMap.Entry e : resets.int2IntEntrySet()) edge.addReset(e.getIntKey(), e.getIntValue());
                }
        }
...
// PTA
  ...
  static final public Int2IntMap Resets(astPTA pta) throws ParseException {
        Int2IntMap resets = new Int2IntOpenHashMap();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case REG_IDENT:
      Reset(pta, resets);
      label_5:
  ...
  static final public void Reset(astPTA pta, Int2IntMap resets) throws ParseException {
        String clockName;
        int clock;
        int val;
