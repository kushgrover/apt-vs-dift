...
public abstract class Reactions2Prism extends PrismLanguageTranslator
{
	...
	class Reaction
	{
		...
		public IntArrayList reactantStoichs;
		public List<String> products;
		public IntArrayList productStoichs;
		...
		public Reaction(String id, String name)
		{
			...
			reactantStoichs = new IntArrayList();
			products = new ArrayList<>();
			productStoichs = new IntArrayList();
			reversible = false;
			kineticLaw = null;
		...
		public void addReactant(String reactant, int stoich)
		{
			...
			if (i == -1) {
				...
				reactantStoichs.set(i, reactantStoichs.getInt(i) + stoich);
			}
		}
		...
		public void addProduct(String product, int stoich)
		{
			...
			if (i == -1) {
				...
				productStoichs.set(i, productStoichs.getInt(i) + stoich);
			}
		}
		...
		public int before(String species)
		{
			...
			if (i == -1)
				return 0;
			return reactantStoichs.getInt(i);
		}
		...
		public int after(String species)
		{
			...
			if (i == -1)
				return 0;
			return productStoichs.getInt(i);
		}
