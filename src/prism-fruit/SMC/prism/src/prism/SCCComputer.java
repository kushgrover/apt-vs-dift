	...
	public void computeBSCCs() throws PrismException
	{
		...
		if (!verbose && bsccs.size() > 10) {
			...
			for (i = 0; i < bsccs.size(); i++) {
				mainLog.print(" " + (i + 1) + ":" + JDD.GetNumMintermsString(bsccs.get(i), allDDRowVars.n()));
			}
			mainLog.println();
		}
	}
