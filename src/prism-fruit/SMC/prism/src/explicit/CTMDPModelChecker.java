...
public class CTMDPModelChecker extends ProbModelChecker
{
	 ...
	 */
	public ModelCheckerResult computeBoundedUntilProbs(CTMDP ctmdp, NatBitSet remain, NatBitSet target, double t, boolean min) throws PrismException
	{
	 ...
	 */
	public ModelCheckerResult computeBoundedReachProbs(CTMDP ctmdp, NatBitSet remain, NatBitSet target, double t, boolean min, double init[], double results[]) throws PrismException
	{
	 ...
	 * @param results: Optional array of size b+1 to store (init state) results for each step (null if unused)
	 */
	public ModelCheckerResult computeBoundedReachProbsOld(CTMDP ctmdp, NatBitSet remain, NatBitSet target, double t, boolean min, double init[], double results[]) throws PrismException
	{
		// TODO: implement until
		...
		while (iters <= right) {
			...
			ctmdp.mvMultMinMax(soln, min, soln2, NatBitSets.ensureBounded(target, ctmdp.getNumStates()).complement(), null);
	 ...
	 * @param min Min or max probabilities (true=min, false=max)
	 */
	public ModelCheckerResult computeReachProbs(CTMDP ctmdp, NatBitSet target, boolean min) throws PrismException
	{
	 ...
	 */
	public IntList probReachStrategy(CTMDP ctmdp, int state, NatBitSet target, boolean min, double lastSoln[]) throws PrismException
	{
		throw new PrismNotSupportedException("Not implemented yet");
	}
