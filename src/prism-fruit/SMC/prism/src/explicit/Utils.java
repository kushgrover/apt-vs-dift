...
public class Utils
{
	 ...
	 */
	public static double minMaxOverArraySubset(double[] array, IntIterable subset, boolean min)
	{
		if (min)
	 ...
	 * @param subset The subset
	 */
	public static double minOverArraySubset(double[] array, IntIterable subset)
	{
		double d;
	 ...
	 * @param subset The subset
	 */
	public static double maxOverArraySubset(double[] array, IntIterable subset)
	{
		double d;
	...
	/**
	 * Create an n-element array of doubles (0s and 1s) from a NatBitSet.
	 *
	 * @param bs The bitset specifying 0s and 1s
	 * @param n  The size of the array.
	 */
	public static double[] intSetToDoubleArray(IntSet bs, int n)
	{
		double res[] = new double[n];
		bs.forEach((IntConsumer) i -> res[i] = 1.0);
		return res;
	}
	 ...
	 *
	 * @param array  The array to be cloned
	 * @param copyTo The destination array (should exist and be same size)
	 */
