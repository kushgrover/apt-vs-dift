...
public abstract class ECComputer extends PrismComponent
{
	 ...
	 * Static method to create a new ECComputer object, depending on current settings.
	 */
	public static ECComputer createECComputer(NondetModel model) throws PrismException
	{
		// Only one algorithm implemented currently
	 ...
	 * Base constructor.
	 */
	public ECComputer() throws PrismException
	{
		super();
	}
	 ...
	 */
	public abstract void computeMECStates(NatBitSet restrict) throws PrismException;
	 ...
	 */
	public abstract void computeMECStates(NatBitSet restrict, NatBitSet accept) throws PrismException;

	/**
	 * Get the list of states for computed MECs.
	 */
	public abstract List<NatBitSet> getMECStates();
}
