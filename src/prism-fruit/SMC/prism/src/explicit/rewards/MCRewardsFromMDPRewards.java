...
public class MCRewardsFromMDPRewards implements MCRewards
{
	...
	protected MDStrategy strategy = null;

	/**
	 * Constructor: create from MDP rewards and memoryless adversary.
	 */
	public MCRewardsFromMDPRewards(MDPRewards mdpRewards, MDStrategy strategy)
	{
	...
	public double getStateReward(int s)
	{
		...
		return mdpRewards.getStateReward(s) + mdpRewards.getTransitionReward(s, strategy.getChoiceIndex(s));
	}
