...
public class VarList
{
	...
	private Object2IntMap<String> nameMap;
	...
	public void addVar(int i, Declaration decl, int module, Values constantValues) throws PrismLangException
	{
		...
		int j, n;
		n = getNumVars();
		nameMap = new Object2IntOpenHashMap<>(n);
		for (j = 0; j < n; j++) {
	 ...
	 */
	public State convertBitSetToState(IntSet bits)
	{
		int i, n, j, var, val;
		State state;
	...
	public Object clone()
	{
		...
		rv.nameMap = new Object2IntOpenHashMap<>(n);
		for (i = 0; i < n; i++) {
