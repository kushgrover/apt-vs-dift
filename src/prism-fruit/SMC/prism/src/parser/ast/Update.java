...
public class Update extends ASTElement
{
	...
	private List<ExpressionIdent> varIdents;
	...
	public void add(ExpressionIdent v, Expression e)
	{
		vars.add(v.getName());
		exprs.add(e);
	...
	public ASTElement deepCopy()
	{
		...
		n = getNumElements();
		for (i = 0; i < n; i++) {
			ret.add((ExpressionIdent) getVarIdent(i).deepCopy(), getExpression(i).deepCopy());
