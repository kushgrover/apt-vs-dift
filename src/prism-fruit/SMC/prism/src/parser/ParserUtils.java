...
public class ParserUtils
{
	 ...
	 * with respect to a variable list and some values for constants.
	 */
	public static IntCollection findAllValsForIntExpression(Expression expr, VarList varList, Values constantValues) throws PrismLangException
	{
		List<String> vars;
		List<Values> allValues;
		IntSet res;
