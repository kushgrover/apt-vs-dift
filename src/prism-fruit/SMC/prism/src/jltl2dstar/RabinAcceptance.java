 ...
 */
public class RabinAcceptance implements IntIterable
{
	 ...
	 *  @return the MyBitSet where the results are stored, has to be clear
	 *                at the beginning!
	 */
	...
	public static class AcceptancePairIterator implements IntIterator
	{
