...
public class LTL2Rabin {
	...
	public static automata.DA<NatBitSet, AcceptanceRabin> ltl2rabin(SimpleLTL ltlFormula) throws PrismException
	{
		DA<NatBitSet, ? extends AcceptanceOmega> result;
		result = ltl2da(ltlFormula, AcceptanceType.RABIN);
		return (DA<NatBitSet, AcceptanceRabin>)result;
	}

	@SuppressWarnings("unchecked")
	public static automata.DA<NatBitSet, AcceptanceStreett> ltl2streett(SimpleLTL ltlFormula) throws PrismException
	{
		DA<NatBitSet, ? extends AcceptanceOmega> result;
		result = ltl2da(ltlFormula, AcceptanceType.STREETT);
		return (DA<NatBitSet, AcceptanceStreett>)result;
	}

	public static automata.DA<NatBitSet, ? extends AcceptanceOmega> ltl2da(SimpleLTL ltlFormula, AcceptanceType... allowedAcceptance) throws PrismException
	{
