...
public class GUISimulationPicker extends javax.swing.JDialog implements KeyListener
{
	...
	private void initComponents()//GEN-BEGIN:initComponents
	{
		...
		if (!atLeastOneQuant)
			methods.add("SPRT");
		selectSimulationMethod.setModel(new javax.swing.DefaultComboBoxModel(methods.toArray(new String[methods.size()])));

		selectSimulationMethod.addActionListener(evt -> selectSimulationMethodActionPerformed(evt));

		automaticCalculateCombo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { }));
		automaticCalculateCombo.addActionListener(evt -> automaticCalculateComboActionPerformed(evt));
