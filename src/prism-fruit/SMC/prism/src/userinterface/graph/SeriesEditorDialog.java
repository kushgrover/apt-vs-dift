...
public class SeriesEditorDialog extends JDialog
{
    ...
    public static void makeSeriesEditor(GUIPlugin plugin, JFrame parent, Graph graph, List<Graph.SeriesKey> series)
    {
	...
	private SeriesEditorDialog(GUIPlugin plugin, JFrame parent, Graph graph, List<Graph.SeriesKey> series)
	{
	...
	private class SeriesEditor extends JPanel  implements ActionListener
	{
		...
		private SeriesEditor(Graph graph, PrismXYSeries xySeries, SeriesSettings settings, Action cut, Action copy, Action paste, Action delete)
		{
			...
			this.xySeries.addChangeListener(event -> SeriesEditor.this.tableModel.fireTableStructureChanged());
		...
		public void copy()
		{
		    ...
		    for(int i = 0; i < rows.length ; i++)
		    {
		    	...
		    	if (row < xySeries.getItemCount())
		    	{
		    		...
		    		clippy.append(item.getX()).append("\t").append(item.getY()).append("\n");
		    	}
		    	else
		    	{
		    		...
		    		clippy.append(x).append("\t").append(y).append("\n");
		    	}
		    }
