...
public class GUIGraphPicker extends javax.swing.JDialog
{
	...
	private List<DefinedConstant> multiSeries;
	...
	public GUIGraphPicker(GUIPrism parent, GUIPlugin plugin, GUIExperiment experiment, GUIGraphHandler graphHandler, boolean resultsKnown)
	{
		...
		this.multiSeries = new ArrayList<DefinedConstant>();
		...
		if (!graphCancelled) {
			/* Collect series keys. */
			List<Graph.SeriesKey> seriesKeys = new ArrayList<Graph.SeriesKey>();
	...
	public void resetAutoSeriesName()
	{
		...
		multiSeries = new ArrayList<DefinedConstant>();
