...
public class AcceptanceReachDD implements AcceptanceOmegaDD
{
	...
	/**
	 * Constructor, from a NatBitSet-based AcceptanceReach.
	 *
	...
	public AcceptanceReachDD(AcceptanceReach acceptance, JDDVars ddRowVars)
	{
		...
		acceptance.getGoalStates().forEach((IntConsumer) i -> goalStates = JDD.SetVectorElement(goalStates, ddRowVars, i, 1.0));
	}
