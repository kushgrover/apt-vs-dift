...
public class APElement extends MyBitSet {
	...
	public APElement(MyBitSet m) {
		super(m.size());
		m.iterator().forEachRemaining((IntConsumer) this::set);
	}
	...
	{
		return toStringHOA(NatBitSets.asSet(this), apSetSize);
	}
	 ...
	 * @param apSetSize the size of the underlying AP set
	 */
	public static String toStringHOA(NatBitSet label, int apSetSize)
	{
		if (apSetSize == 0) {
			return "t";
		}
